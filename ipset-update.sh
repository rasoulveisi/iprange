...
# Usage: wget -O - https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/ipset-update.sh | sh
...
# Ensure you have wget or curl installed. Using wget as per your script.
...
# We look for the section index (e.g., @ipset[0]) that has option name 'iran'
...
# 7. RESTART (Optional but Recommended)
# Restarting ensures everything is synced perfectly.
